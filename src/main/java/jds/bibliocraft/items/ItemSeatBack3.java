...
public class ItemSeatBack3 extends Item
{
	...
	public static final String name = "seatback3";
	public static final ItemSeatBack3 instance = new ItemSeatBack3();
	
	public ItemSeatBack3()
	{
		super();
    ...
    public void getSubItems(CreativeTabs tab, NonNullList<ItemStack> list)//Item itemID, CreativeTabs tabs, List list)
    {
